  ...
  return (
    <section className='mx-auto max-w-md px-4 py-12 sm:px-6'>
      <div className='rounded-2xl border border-slate-800 bg-slate-900 p-6 sm:p-8'>
        ...
        <p className='mt-2 text-sm text-slate-400'>Start organizing your development work.</p>
        ...
        <form onSubmit={handleSubmit} className='mt-6 space-y-4'>
          <div>
            ...
            <input type='text' value={name} onChange={e => setName(e.target.value)} required minLength={2} maxLength={50} autoComplete='name' className='w-full rounded-xl border border-slate-700 bg-slate-950 px-4 py-3 text-sm text-slate-100 outline-none focus:border-cyan-400' />
          </div>
          ...
          <div>
            ...
            <input type='password' value={password} onChange={e => setPassword(e.target.value)} required minLength={8} autoComplete='new-password' className='w-full rounded-xl border border-slate-700 bg-slate-950 px-4 py-3 text-sm text-slate-100 outline-none focus:border-cyan-400' />
          </div>
